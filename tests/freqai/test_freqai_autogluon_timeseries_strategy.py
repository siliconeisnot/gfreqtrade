...
def test_freqai_autogluon_timeseries_strategy_backtest(mocker, freqai_conf):
    ...
    freqai_conf["strategy_path"] = "freqtrade/templates"
    ...
    mocker.patch(
        ...
        "AutoGluonTimeSeriesPredictor.AutoGluonTimeSeriesPredictor.fit",
        dummy_fit,
    )
    ...
    mocker.patch(
        "freqtrade.resolvers.strategy_resolver.StrategyResolver._strategy_sanity_validations",
        return_value=None,
    )
