...
class FreqaiAutoGluonTimeSeriesStrategy(IStrategy):
    ...
    The AutoGluonTimeSeriesPredictor expects a `freq` entry in
    `freqai.model_training_parameters` describing the data frequency
    (e.g. "1h").
    If omitted it defaults to the strategy timeframe.
