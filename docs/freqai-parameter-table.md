...
| `min_feature_importance` | Drop features with importance lower than this threshold, then retrain the model with the reduced feature set. <br> **Datatype:** Float. <br> Default: `0`.
