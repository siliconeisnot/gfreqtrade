...
| `quantiles` | List of quantile levels to forecast when supported by the selected model. Predictions are returned as additional columns named `<label>_<quantile>` (e.g., `&-s_close_0.1`). <br> **Datatype:** List of floats between 0 and 1.|
